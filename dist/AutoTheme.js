export class AutoTheme {
    ...
    #addColors(color, shadeMin, shadeMax) {
        const keys = ["primary", "secondary", "tertiary", "accent", "neutral"];
    ...
    addComplementary() {
        const keys = ["primary", "secondary", "tertiary", "accent", "neutral"];
        const colors = [this.baseColor, this.baseColor, this.baseColor, this.baseColor, this.baseColor];
    ...
    static deserialize(serializedTheme, escapeChar = "|") {
        ...
        for (const prop of themeObjectProps) {
            ...
            for (const objValueProp of objValueProps) {
                ...
                // @ts-ignore
                AutoTheme.#addColorProperty(theme[objKey], objValueKey, ObjValueValue);
            }
        }
        return theme;
    }
    ...
    static #addColorGroups(theme) {
        const groups = ["analogous", "monochromatic", "triad", "complementary", "splitComplementary", "square", "compound", "shades"];
